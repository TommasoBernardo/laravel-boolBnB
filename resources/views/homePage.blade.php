        ...
        <div class="search-box-hero d-flex justify-content-center align-items-center ">
            <div class="row">
                ...
                <div class="row justify-content-center">
                    ...
                    <p id="mexErrore" class="text-center  alert alert-warning fs-1 col-7 m-0 d-none">Write an address into the searchbar</p>
                </div>
            </div>
        </div>
...
<div class="container mb-5">
    <div class="row mb-5 align-items-center">
        ...
        <div class="col-lg-3 col-md-6 col-sm-12 div-wrap-button-properties">
            <a href="{{ route('apartments.index') }}" class="btn text-white custom-button button-properties rounded-5 text-sm-center" style="background-color:rgb(0, 85, 85)">View all properties</a>
        </div>
    </div>
