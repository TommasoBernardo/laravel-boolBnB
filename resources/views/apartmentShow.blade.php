                ...
                <div class="row justify-content-center p-5">
                    <div class="col-lg-6 col-md-12 col-sm-1">
                        <div class="mb-3 text-light fw-bold">
                            <label for="" class="form-label">Inserisci li tuo nome <i
                                    class="fa-solid fa-user icon-send-email"></i></label>
                            <input type="text" class="form-control input-email-user" id="" placeholder="luca">
                        </div>
                        <div class="mb-3 text-light fw-bold">
                            <label for="email-user" class="form-label">Inserisci la tua email <i
                                    class="fa-solid fa-envelope-circle-check icon-send-email"></i> </label>
                            <input type="email" class="form-control input-email-user" id=""
                                placeholder="youemail@example.com">
                        </div>
                        <div class="mb-3 text-light fw-bold">
                            <label for="" class="form-label">Inserisci li tuo numero di telefono <i
                                    class="fa-solid fa-phone icon-send-email"></i> </label>
                            <input type="number" class="form-control input-email-user" id="" placeholder="+39">
                        </div>
                        <div class="mb-3 text-light fw-bold">
                            <label for="text-user" class="form-label">Facci sapere la tua esperienza, scrivici qualcosa! <i
                                    class="fa-solid fa-comment icon-send-email"></i></label>
