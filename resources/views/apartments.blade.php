                    ...
                    <div id="my-card" class="card mt-5" style=" height: 35rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex mb-4">
                                <p class="card-text me-3">{{ $apartment->rooms }} <i class="fa-solid fa-house"
                                        style="color: #005555 "></i> </p>
                                <p class="card-text"> {{ $apartment->beds }} <i class="fa-solid fa-bed"
                                        style="color: #005555 "></i> </p>
                            </div>
                            <div class=" d-flex justify-content-center div-button-icon">
                                <a href="{{ route('apartments.show', $apartment->slug) }}"
                                    class="btn placeholder-glow  btn-green" id="border"
