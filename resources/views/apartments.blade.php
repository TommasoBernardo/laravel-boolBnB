                    ...
                    <div class="row list-filter">
                        <div class="col-lg-4 col-md-6 col">
                            <div class="input-container">
                                <input placeholder="Filtra per numero di letti" class="input-field" type="text" name="beds" min="0" id="beds">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="input-container">
                                <input placeholder="Filtra per numero di stanze" class="input-field" type="text" name="rooms" min="0" id="rooms">
